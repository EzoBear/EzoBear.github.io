...
Feature Selective Anchor-Free<br>
=============
...
## 1. Feature Selective Anchor-Free Module<br>
 ...
 * Class Module <br>
 ...
 1. Effective Region<br>
##

> $$b_e^l= [x_e^l, y_e^l, w_e^l, h_e^l]$$(3)<br>
...
그림에서 흰색 영역입니다. Instance가 존재하는 영역으로 positive value 로 채워져있으며, 직접적인 학습에 영향을 미치는 영역입니다. 만약에 한 레벨에서 Effective Region이 겹치게 될 경우 작은 Effective Region(Small Object)가 우선순위를 갖게 됩니다.<br>
 ...
 2. Ignoring Region<br>
##

> $$b_i^l= [x_i^l, y_i^l, w_i^l, h_i^l]$$(4)<br>
